...
describe("viz_high_level projection anchoring", function()
	...
	it("counts non-projectable events without drawing them", function()
		...
		local snap = require("viz_high_level.core.headless_renderer").render(runtime, {
			other = { 0.5, 0.5, 0.5, 1 },
			joined = { 0, 1, 0, 1 },
			expired = { 1, 0, 0, 1 },
		})
...
describe("viz_high_level projection enrichment", function()
