...
Think of `row` as “one table per schema in the query”, with missing partners represented as empty tables. See `records_and_schemas.md` if you want the full data‑structure details.
